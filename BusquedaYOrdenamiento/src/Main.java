...
public class Main {
    public static void main(String[] args) {
        ...
        OrdenamientoPorQuickSort ordenamientoPorQuickSort = new OrdenamientoPorQuickSort();
        ...
        do {
            ...
            switch (opciónMenúPrincipal) {
                ...
                case 4:
                    ...
                    ordenamientoPorBurbuja.ordenar(arregloPrincipal);
                ...
                case 7:
                    arregloPrincipal = pedirArreglo();
                    ordenamientoPorQuickSort.ordenar(arregloPrincipal);
                    mostrarArregloEnUnaLínea(arregloPrincipal);
                    break;
                case 8:
                    arregloPrincipal = pedirArreglo();
